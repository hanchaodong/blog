...
<link rel="stylesheet" type="text/css" media="screen" href="/Public/style/style.css"  />
...
<script src="/Public/style/post.js"></script>
<title>该去北上广哭，还是回小城市笑_意空间阅读网</title>		<script type="text/javascript">
...
<link rel="alternate" type="application/json+oembed" href="http://yispace.net/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fyispace.net%2F42805.html" />
<link rel="alternate" type="text/xml+oembed" href="http://yispace.net/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fyispace.net%2F42805.html&#038;format=xml" />
...
<div class="topbar">
	<div class="inner">
		<a class="logo" href="http://yispace.net" title="意空间阅读网_美文网_美文欣赏_经典美文_励志文章_优美散文">意空间阅读网</a>
		<ul class="nav">
			<?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($current == $vo['id']): ?>class='current-menu-item'<?php endif; ?> ><a href="/index.php/Home/Cate/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
</div>
<div class="wrapper">
...
<div class="meta">
	...
	<p class="meta-info">发表：<a href="/index.php"><?php echo ($catename); ?></a> &nbsp;&nbsp; 发表日期：<?php echo (date("Y-m-d",$arts["time"])); ?> &nbsp;&nbsp; </p>
</div>

<!-- 广告代码2 -->

<div class="entry">
	<p><img class="aligncenter size-full wp-image-42806" src="<?php echo ($arts["pic"]); ?>" width="630" height="399" sizes="(max-width: 630px) 100vw, 630px" /></p>
...
<a class="prev-post icon-right" href="/index.php/Home/Article/index/id/<?php echo ($prevs["id"]); ?>">
...
<a class="next-post" href="/index.php/Home/Article/index/id/<?php echo ($nexts["id"]); ?>">
...
<div class="sidebar">
	...
	<ul>
	<?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="cat-item cat-item-18"><a href="/index.php/Home/Cate/index/id/<?php echo ($vo["id"]); ?>" ><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
</div>
